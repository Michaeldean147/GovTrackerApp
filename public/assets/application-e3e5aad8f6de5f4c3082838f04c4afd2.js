...
$(document).ready(function(){
  ...
  $('#legisNames').on('click', 'p', function(){
    ...
    $.ajax(legisInfoUrl, {dataType: 'json'}).done(function(data){
      $('#legisNames').append('<li>' + data["results"][0].chamber + '</li>')
      $('#legisNames').append('<li>' + data["results"][0].phone + '</li>')
      $('#legisNames').append('<li>' + data["results"][0].twitter_id + '</li>')
      $('#legisNames').append('<li>' + data["results"][0].party + '</li>')
      $('#legisNames').append('<img src= "assets/images/' + legisBioId + '.jpg">')
